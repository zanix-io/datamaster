...
- Exposed the cache type definitions through the ./cache/types package export. This allows consumers
  to import cache-related types directly from the package without relying on internal source paths.
