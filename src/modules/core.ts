...
/**
 * Side-effect-only module that auto-registers the default Mongo, Redis, local-cache, SQLite, and
 * Elasticsearch/OpenSearch connectors/providers with the Zanix DI container.
 *
